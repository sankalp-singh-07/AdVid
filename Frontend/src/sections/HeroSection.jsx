...
export default function HeroSection() {
    return (
        <div className="flex flex-col items-center justify-center text-center bg-[url('/assets/hero-section-dot-image.png')] bg-cover bg-no-repeat">
            ...
            <p className="text-base text-slate-600 max-w-lg mt-5">Upload your product and model images, and let AI generate stunning ad videos ready for social media. No editing skills required.</p>
